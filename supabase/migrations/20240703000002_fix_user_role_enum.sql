...
DROP POLICY IF EXISTS "Super admins can do anything with beneficiaries" ON beneficiaries;
...
DROP POLICY IF EXISTS "Admins and clerks can manage their mosque's beneficiaries" ON beneficiaries;
...
DROP POLICY IF EXISTS "Super admins can do anything with givers" ON givers;
...
DROP POLICY IF EXISTS "Admins and clerks can manage their mosque's givers" ON givers;
...
DROP POLICY IF EXISTS "Super admins can do anything with distributions" ON zakat_distributions;
...
DROP POLICY IF EXISTS "Admins and clerks can manage their mosque's distributions" ON zakat_distributions;
...
DROP POLICY IF EXISTS "Super admins and admins can manage products" ON product_types;
...
DROP POLICY IF EXISTS "Clerks can view products" ON product_types;
